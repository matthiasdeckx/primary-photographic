...
export function HomeFeatureSlides({ slides }: { slides: HomeFeatureSlide[] }) {
  ...
  return (
    ...
    >
      <div className="home-intro-logo pointer-events-none fixed left-0 top-0 z-10 flex h-dvh w-full select-none items-center justify-center pt-[env(safe-area-inset-top,0px)] pb-[env(safe-area-inset-bottom,0px)] lg:hidden">
        <SiteLogoFrame>
